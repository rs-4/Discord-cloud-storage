...
class discordService {
  ...
  async attachementRequest(files: File[]): Promise<UploadInfo[]> {
    ...
    while (i < loop) {
      ...
      const resp = await axios({
        method: "post",
        url: `https://discord.com/api/v9/channels/1214637481497067540/attachments`,
        headers: {
  ...
  async retrieveFileUrl(uploadInfo: UploadInfo[]): Promise<fileDiscordInfo[]> {
    ...
    while (i < loop) {
      ...
      const resp = await axios({
        method: "post",
        url: "https://discord.com/api/v9/channels/1214637481497067540/messages",
        headers: {
          Authorization: this.DiscordToken,
          "Content-Type": "application/json"
        },
        data: {
          "content": "",
          "channel_id": "1214637481497067540",
          "type": 0,
          "sticker_ids": [],
